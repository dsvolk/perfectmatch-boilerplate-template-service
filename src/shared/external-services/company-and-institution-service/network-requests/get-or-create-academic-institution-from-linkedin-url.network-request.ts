...
export class GetOrCreateAcademicInstitutionFromLinkedinUrlNetworkRequest extends NetworkRequest<any> {
  ...
  getUrl(): string {
    return `${this.baseUrl}/v1/academic-institutions/linkedin/profile`;
  }
}
